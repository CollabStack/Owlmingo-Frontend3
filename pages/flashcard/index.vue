<template>
    ...
    <v-app>
      <v-container class="d-flex flex-column align-center py-6">
        <h1 class="text-h4 font-weight-bold mb-2">AI Flashcard Generator</h1>
        ...
        <v-card class="w-100 max-w-md pa-6 text-center d-flex flex-column align-center justify-center" outlined>
          <v-icon size="48" class="mb-2">mdi-cloud-upload</v-icon>
          <p class="text-body-2">Drag a {{ selectedTab }} here or click to browse</p>
  ...
  <v-container>
      ...
      <v-col cols="9">
        ...
        >
          <v-btn 
            ...
            :key="index" 
            :value="option.value" 
            class="custom-tab bg-none text-primary outfit outfit-medium"
    ...
    <v-window v-model="tab" class="mt-5">
      ...
      <v-window-item value="document">
        <FileUploader
          ...
          @error="showSnackbar"
        />
        <p class="mt-2 animated-link outfit outfit-regular">Looking for quizzes instead? Try the <nuxt-link to="/quiz" style="text-decoration: none;"> AI Quiz Generator</nuxt-link></p>
      </v-window-item>
      ...
      <v-window-item value="text">
        <div class="ma-4 pa-4" outlined
          ...
          <p class="animated-link outfit outfit-regular mt-4">Looking for quizzes instead? Try the <nuxt-link to="/quiz" style="text-decoration: none;"> AI Quiz Generator</nuxt-link></p>
        </div>
      </v-window-item>
      ...
      <v-window-item value="image">
        <FileUploader
          icon="mdi-image"
          iconColor="secondary"
          placeholder="Drag an image containing text here"
    ...
    >
      ...
      >
        <v-progress-circular
          ...
          size="64"
        ></v-progress-circular>
        <p class="mt-4 outfit outfit-medium">Processing your content...</p>
      </v-card>
    </v-overlay>
    ...
    <v-snackbar v-model="snackbar" :timeout="3000" top>
      ...
      <template v-slot:actions>
        <v-btn color="pink" text @click="snackbar = false" class="outfit outfit-medium">Close</v-btn>
      </template>
    </v-snackbar>
  </v-container>
