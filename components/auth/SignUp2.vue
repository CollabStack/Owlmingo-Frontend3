        ...
        <v-row class="d-flex align-center">
            ...
            <v-col cols="12" md="6" class="d-flex flex-column justify-center">
                <div class="auth-form-container"
                    ...
                    <v-form class="auth-form" ref="form" v-model="isFormValid" @submit.prevent="signUp">
                        <!-- Error alert -->
                        <v-alert
                            v-if="errorMessage"
                            type="error"
                        ...
                        >
                            <span class="d-flex justify-center align-center w-100">
                                ...
                                <v-icon class="ms-2 btn-icon">Sign Up</v-icon>
                            </span>
                        </v-btn>
                        ...
                        <div class="social-login-container d-flex justify-center mb-6">
                            <v-tooltip text="Sign up with Google" location="top">
                            ...
                            <v-tooltip text="Sign up with GitHub" location="top">
                                <template v-slot:activator="{ props }">
                            ...
                            <v-tooltip text="Sign up with Telegram" location="top">
                                <template v-slot:activator="{ props }">
                        ...
                        <div class="sign-up-container d-flex justify-center align-center outfit outfit-regular">
                            <span class="text-grey-darken-1 mr-2">Already have an account?</span>
                            <NuxtLink to="/auth/sign-in" class="text-decoration-none text-secondary font-weight-bold outfit outfit-medium">
                                Sign In
                            </NuxtLink>
                        </div>
                    </v-form>
...
const signUp = async () => {
    ...
    try {
        ...
        errorMessage.value = error?.message || 'Sign up failed. Please check your details and try again.';
    } finally {
...
const socialLogin = async (provider) => {
    ...
    try {
        ...
        errorMessage.value = `${provider.charAt(0).toUpperCase() + provider.slice(1)} sign up failed. Please try again later.`;
    } finally {
        isLoading.value = false;
    }
};
